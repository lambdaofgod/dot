...
exec_always xrandr --output HDMI-1-0 --auto --primary; xrandr --output eDP-1 --left-of HDMI-1-0; xrandr DP-1-1 --left-of eDP-1
...
# switch to workspace
bindsym $mod+Home workspace $wsorg
...
bindsym $mod+Shift+Home move container to workspace $wsorg
...
assign [class="Emacs"] 11
assign [class="guake"] 2
assign [class="9"] 5
