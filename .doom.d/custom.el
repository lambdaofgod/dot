(custom-set-variables
 ...
 '(package-selected-packages
      '(exercism flycheck-credo elixir-mode nushell-mode nu-mode org-fancy-priorities company-tabnine org-roam-ui pyenv-mode org-ai nix-mode nixpkgs-fmt ob-async helm-youtube request hyperbole xterm-color docker-tramp org-ref python-black aggressive-indent elisp-format blacken)))
(custom-set-faces
