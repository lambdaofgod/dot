(custom-set-variables
 ...
 '(org-safe-remote-resources '("\\`https://fniessen\\.github\\.io\\(?:/\\|\\'\\)"))
  '(package-selected-packages
       '(org-ai nix-mode nixpkgs-fmt ob-async helm-youtube request hyperbole xterm-color docker-tramp org-ref python-black aggressive-indent elisp-format blacken)))
(custom-set-faces)
